...
import OBSERVACTION_FIELD from '@salesforce/schema/Bear__c.Observations__c';
const bearFields = [SUPERVISOR_FIELD, OBSERVACTION_FIELD];
//const bearFields = [Observations__c_FIELD];
